...
class Texture extends _Texture {
  ...
  updateByPixels(buffer, width, height, x, y) {
    validateTypeOf(buffer, 'buffer', Buffer);
    validateTypeOf(width, 'width', 'number', true);
    validateTypeOf(height, 'height', 'number', true);
    validateTypeOf(x, 'x', 'number', true);
    validateTypeOf(y, 'y', 'number', true);
    super.updateByPixels(buffer, width, height, x, y);
  }
