...
const Vector2I = createClass(
  'Vector2I',
  _Vector2I,
  () => true,
  v => parseInt(v));
_Vector2I.setRealConstructor((...args) => new Vector2I(...args));

const Vector2U = createClass(
  'Vector2U',
  _Vector2U,
  v => {
    if (v < 0) {
  ...
  v => parseInt(v));
_Vector2U.setRealConstructor((...args) => new Vector2U(...args));

const Vector2F = createClass('Vector2F', _Vector2F, () => true);
_Vector2F.setRealConstructor((...args) => new Vector2F(...args));
