...
class Image extends _Image {
  copy(src, destX, destY, sourceRect, applyAlpha) {
    ...
    validateTypeOf(sourceRect, 'sourceRectOrApplyAlpha', [ 'boolean', IntRect ], true);
  ...
  create(width, height, colorOrPixels) {
    ...
    validateTypeOf(colorOrPixels, 'colorOrPixels', [ Color, Buffer, Array, ArrayBuffer, Uint8Array, 'number' ]);
